    ...
    <div class="row">    
     ...
     <%=MenuGenerator.WebPartHeader("MAINTAINING QUALIFICATION")%>                                      
        ...
        <div class="col s12 m4">
            ...
            <%=MenuGenerator.WebPartHeader("POINTS RATE")%>
              Every Dollar Value<span style="color:red">*</span>
                                ...
                                <div class="col s12 m4">
                                        ...
                                        <div class="file-field input-field">
                                         ...
                                         <asp:Button ID="deletebutton" runat="server" Text="Delete Image" class="btn waves-effect waves-light grey darken-2 caishbutton"   />
