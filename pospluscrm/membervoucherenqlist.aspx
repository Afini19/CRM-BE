<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="membervoucherenqlist.aspx.vb" Inherits="membervoucherenqlist_class" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="ctbody" ContentPlaceHolderID="ContentArea" runat="server">
    <div class="caishform" <%=Framework_MenuLeftCSS%>>
        <form id="frmform" runat="server" class="theform">
            ...
            <!--#include File="~/searchmenu/membervoucherenq.aspx"-->
