<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="memberdashboard.aspx.vb" Inherits="memberdashboard_class" MasterPageFile="~/Site.Master" %>  
...
<br />
    ...
    <!--#include File="~/searchmenu/pospluscrm-md.aspx"-->
