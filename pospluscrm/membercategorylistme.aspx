<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="membercategorylistme.aspx.vb" Inherits="membercategorylistme_class" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="ctbody" ContentPlaceHolderID="ContentArea" runat="server">
    <div class="caishform" <%=Framework_MenuLeftCSS%>>
        <form id="frmform" runat="server" class="theform">
            ...
            <!--#include File="~/searchmenu/membercategoryme.aspx"-->
