<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="membermanualvoucher.aspx.vb" Inherits="membermanualvoucher_class" MasterPageFile="~/Site.Master" %>  
    ...
    <div class="row">    
        <div class="col s12 m4">
            ...
            <%=MenuGenerator.WebPartHeader("VOUCHER DETAILS")%>
                                    ...
                                    <asp:TextBox id="vo_code" runat="server" class="form-input" Enabled="false"></asp:TextBox>          
                                    
                                     Voucher Name<span style="color:red">*</span>
                                    <asp:TextBox id="vo_name" runat="server" class="form-input" Enabled="false"></asp:TextBox>     
        ...
        <div class="col s12 m4">
            ...
            <%=MenuGenerator.WebPartHeader("VALIDITY SETTINGS")%>
                 ...
                 <div class="col s12 m6">
                        <uc:AXFormEntry ID="Eventcode" Caption="Event Code" FieldType="text" Lookup="PROMO" Required="false" runat="server"  />                            
                             <br />
