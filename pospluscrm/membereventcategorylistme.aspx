<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="membereventcategorylistme.aspx.vb" Inherits="membereventcategorylistme_class" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="ctbody" ContentPlaceHolderID="ContentArea" runat="server">
    <div class="caishform" <%=Framework_MenuLeftCSS%>>
        <form id="frmform" runat="server" class="theform">
            ...
            <!--#include File="~/searchmenu/membereventcategoryme.aspx"-->
