<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="membervouchertranslist.aspx.vb" Inherits="membervouchertranslist_class" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="ctbody" ContentPlaceHolderID="ContentArea" runat="server">
    <div class="caishform" <%=Framework_MenuLeftCSS%>>
        <form id="frmform" runat="server" class="theform">
            ...
            <!--#include File="~/searchmenu/membervouchertrans.aspx"-->
