<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="salesch.aspx.vb" Inherits="salesch_class" MasterPageFile="~/Site.Master" %>  
...
<asp:Content ID="cttopbody" ContentPlaceHolderID="topbody" runat="server">  
    ...
    <div class="row">    
        <div class="col s6 m3">
                                    Sales Channel Code<span style="color:red">*</span>
    ...
    <div class="row">    
        <div class="col s12 m5">
                                    Sales Channel Name<span style="color:red">*</span>
