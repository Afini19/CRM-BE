<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="productpluadminlist.aspx.vb" Inherits="productpluadminlist_class" MasterPageFile="~/Site.Master" %>  
...
<asp:Content ID="ctbody" ContentPlaceHolderID="ContentArea" runat="server">  
      ...
      <!--#include File="~/searchmenu/plugeneral.aspx"-->
</form>
</div>
</asp:Content>
...
{
  $.colorbox({transition:"none",height:'90%',width:'98%',iframe:'true',href:"popup-enquirystockbalbybranch.aspx?p1=" + $('#<%=table1sel0.clientid%>').val()});
}
function performdrill2()
{
  $.colorbox({transition:"none",height:'90%',width:'98%',iframe:'true',href:"popup-enquirystockbalbylotsumm.aspx?p1=" + $('#<%=table1sel0.clientid%>').val()});
}
function performdrill3()
{
  $.colorbox({transition:"none",height:'90%',width:'98%',iframe:'true',href:"popup-enquirystockbalbylotdet.aspx?p1=" + $('#<%=table1sel0.clientid%>').val()});
}
