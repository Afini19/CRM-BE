<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="area.aspx.vb" Inherits="area_class" MasterPageFile="~/Site.Master" %>  
...
<asp:Content ID="cttopbody" ContentPlaceHolderID="topbody" runat="server">  
    ...
    <div class="row">    
        <div class="col s6 m3">
                                    ...
                                    <asp:TextBox id="co_codevalue" runat="server" class="form-input">
    ...
    <div class="row">    
        <div class="col s12 m5">
                                    ...
                                    <asp:TextBox id="co_description" runat="server" class="form-input">
    ...
    <div class="row">    
        <div class="col s12 m5">
                                     <uc:AXFormEntry ID="co_para2" Caption="State" FieldType="text" Lookup="STATES" Required="true" runat="server"  />                            
    ...
    <div class="row">    
        <div class="col s12 m5">
                                     <uc:AXFormEntry ID="co_para1" Caption="Region" FieldType="text" Lookup="REGION" Required="false" runat="server"  />                            
