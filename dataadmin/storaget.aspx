<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="storaget.aspx.vb" Inherits="storaget_class" MasterPageFile="~/Site.Master" %>  
...
<asp:Content ID="cttopbody" ContentPlaceHolderID="topbody" runat="server">  
    ...
    <div class="row">    
        <div class="col s6 m3">
                                    Storage Type Code<span style="color:red">*</span>
    ...
    <div class="row">    
        <div class="col s12 m5">
                                    Storage Type Name<span style="color:red">*</span>
