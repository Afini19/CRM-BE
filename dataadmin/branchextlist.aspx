<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="branchextlist.aspx.vb" Inherits="branchextlist_class" MasterPageFile="~/Site.Master" %>  
...
<!--#include File="~/navbarl2.aspx"-->
        ...
        <a class="<%=TableUtils.FloatButtonClass%>" onclick="$('#<%=eventtype.clientid%>').val('ADD');$('[id*=<%=eventfire.clientid%>]').click();"><i class="material-icons">add</i></a>
        </div>
