<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="zone.aspx.vb" Inherits="zone_class" MasterPageFile="~/Site.Master" %>  
...
<!--#include File="~/navbarl3.aspx"-->
        ...
        <a class="<%=TableUtils.FloatButtonClass%>" onclick="$('#<%=eventtype.clientid%>').val('SAVE');$('[id*=<%=eventfire.clientid%>]').click();"><i class="material-icons">save</i></a>
        </div>
</asp:Content>  
