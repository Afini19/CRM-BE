<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="currency.aspx.vb" Inherits="currency_class" MasterPageFile="~/Site.Master" %>  
...
<asp:Content ID="cttopbody" ContentPlaceHolderID="topbody" runat="server">  
    ...
    <div class="row">    
        <div class="col s12 m5">
                                    ...
                                    <asp:TextBox id="co_para1" runat="server" class="form-input">
