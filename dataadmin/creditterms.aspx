<%@  Page Language="VB" AutoEventWireup="false" EnableViewState="True" CodeFile="creditterms.aspx.vb" Inherits="creditterms_class" MasterPageFile="~/Site.Master" %>  
...
<asp:Content ID="cttopbody" ContentPlaceHolderID="topbody" runat="server">  
    ...
    <div class="row">    
        <div class="col s6 m3">
                                    ...
                                    <asp:TextBox id="termscode" runat="server" class="form-input">                                    
                                    </asp:TextBox>
    ...
    <div class="row">    
        <div class="col s12 m5">
                                    ...
                                    <asp:TextBox id="termsname" runat="server" class="form-input">                                    
                                    </asp:TextBox>                                                                     
        </div>
    </div>
    <div class="row">    
        <div class="col s12 m2">
         <uc:AXFormEntry ID="thedays" Caption="Due Days" FieldType="number" Required="true" runat="server"  />                                                                                                      
        </div>
  </div>
       ...
       <div class="row">    
        <div class="col s12 m2">
         Period Type
         <asp:DropDownList runat="server" ID="theperiod" class="form-input">
         </asp:DropDownList>                                                                                                       
        </div>
         <div class="col s12 m2">
         
         Date Type<span style="color:red">*</span>
         <asp:DropDownList runat="server" ID="thedate" class="form-input">
           </asp:DropDownList>                                                                                                     
        </div>        
         ...
         <div class="row">         
          <div class="col s12 m2">
         <uc:AXFormEntry ID="themonths" Caption="+ (months)" FieldType="" Required="true" runat="server"  />                                                                                                      
        </div>            
