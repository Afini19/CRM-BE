  ...
  <li>  
      <div class="container">
       PLU/UPC :<br />
       <input type="text" runat="server" id="sbplusn" runat="server" style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>
  <li>  
      <div class="container">
       Variant Name :<br />
       <input type="text" runat="server" id="sbpluname" runat="server" style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>
