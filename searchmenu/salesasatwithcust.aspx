       ...
       <div class="container">
        ...
        <table width="100%">
            <tr style="border-bottom: solid 0 white">
                <td width="48%">From:<br /><input type="text" runat="server" id="sbcodefrom" runat="server" style="font-size:0.9rem;background-color:white; text-decoration:none" /></td>
                <td width="4%">&nbsp;</td>
                <td width="48%">To:<br /><input type="text" runat="server" id="sbcodetp" runat="server" style="font-size:0.9rem;background-color:white; text-decoration:none" /></td>
           </tr>        
        </table>
     </div>
   </li>                               
