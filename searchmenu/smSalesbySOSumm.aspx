       ...
       <div class="container">
        <table width="100%">
            <tr style="border-bottom: solid 0 white">
                <td width="48%">Branch From:<br /><input type="text" runat="server" id="sbbranchfrom" runat="server" style="font-size:0.9rem;background-color:white; text-decoration:none" /></td>
                <td width="4%">&nbsp;</td>
                <td width="48%">Branch To:<br /><input type="text" runat="server" id="sbbranchto" runat="server" style="font-size:0.9rem;background-color:white; text-decoration:none" /></td>
           </tr>        
        </table>
     </div>
   </li>
