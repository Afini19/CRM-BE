  ...
  <li>  
      <div class="container">
       Lot Serial :<br />
       <input type="text" runat="server" id="sblotserial" style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>                                
  <li>  
      <div class="container">
       Stock Principal :<br />
       <input type="text" runat="server" id="sbowner" style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>
  <li>  
      <div class="container">
       Site ID :<br />
       <input type="text" runat="server" id="sbsiteid" style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>
  <li>  
      <div class="container">
        Stock Expiring On:-<br />
       <input type="text" runat="server" id="sbexpirydate" class="datepicker"  style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>

  <li>  
      <div class="container">
        Stock Expiring In (days):<br />
       <input type="text" runat="server" id="sbexpirydays"  style="font-size:0.9rem;background-color:white;text-decoration:none" />
       </div>
   </li>
