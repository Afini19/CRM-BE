  ...
  <ul id="slide-out" class="sidenav" style="background-color:<%=WebPersonalised.NavBarColor%>">
    ...
    <li><a href="<%=Page.ResolveClientUrl("~/pospluscrm/emenulist.aspx")%>" class="waves-effect" style="text-decoration:none;color:white"><i class="material-icons" style="color:white">folder</i>e-Menu Setup</a></li>
    <li><a href="<%=Page.ResolveClientUrl("~/pospluscrm/eventlist.aspx")%>" class="waves-effect" style="text-decoration:none;color:white"><i class="material-icons" style="color:white">folder</i>Event Code Admin</a></li>     
    <li><a href="<%=Page.ResolveClientUrl("~/pospluscrm/Membermanualvoucherlist.aspx")%>" class="waves-effect" style="text-decoration:none;color:white"><i class="material-icons" style="color:white">folder</i>Manual Voucher Issue</a></li> 
    <li><a href="<%=Page.ResolveClientUrl("~/pospluscrm/MemberList.aspx")%>"  class="waves-effect" style="text-decoration:none;color:white"><i class="material-icons" style="color:white">folder</i>Member Details</a></li>
    <li><a href="<%=Page.ResolveClientUrl("~/pospluscrm/MemberDashboard.aspx")%>" class="waves-effect" style="text-decoration:none;color:white"><i class="material-icons" style="color:white">folder</i>Member Dashboard</a></li>
  </ul>
