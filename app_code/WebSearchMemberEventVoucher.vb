...
Public Class WebSearchMemberEventVoucher
    ...
    Public Function VoucherValue(ByVal theValue As String, Optional ByVal SearchAccuracy As Integer = 1) As String
    ...
    Public Function EventCode(ByVal theValue As String, Optional ByVal SearchAccuracy As Integer = 1) As String

        If (SearchAccuracy = 1) Then
            Return "vo_eventcode like '%" + theValue.Replace("'", "''") + "%'"
        End If

        Return "vo_eventcode = '" + theValue.Replace("'", "''") + "'"
    End Function
