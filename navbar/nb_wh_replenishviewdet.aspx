 <%
     nb_btn_print1.CssClass = TableUtils.btnprimary

     nb_btn_article.CssClass = TableUtils.btnprimary2
     nb_btn_branch.CssClass = TableUtils.btnprimary2
  ...
  <li>
   ...
   <div style="text-align:left; width:100%"><a class="subheader"><b>PRINT</b></a></div>
    <asp:Button ID="nb_btn_print1" runat="server" Text="Master PickList" class="btn waves-effect waves-light cyan darken-4 caishbutton" />
